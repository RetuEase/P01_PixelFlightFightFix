...
void GameLoop::MainMenuLoop()
{
	...
	initgraph(800, 600); // 初始化图形窗口大小为800*600像素
	setbkcolor(WHITE);
	cleardevice();
	...
	outtextxy(340, 200, _T("开始游戏")); // 按钮文字

	// 绘制飞机工厂按钮
	setfillcolor(BLUE);
	fillrectangle(300, 300, 500, 350); // 按钮背景
	settextcolor(WHITE);
	setbkmode(TRANSPARENT);
	settextstyle(40, 0, _T("微软雅黑"));
	outtextxy(340, 300, _T("飞机工厂")); // 按钮文字

	// 绘制操作说明按钮
	setfillcolor(BLUE);
	fillrectangle(300, 400, 500, 450); // 按钮背景
	settextcolor(WHITE);
	setbkmode(TRANSPARENT);
	settextstyle(40, 0, _T("微软雅黑"));
	outtextxy(340, 400, _T("操作说明")); // 按钮文字

	// 绘制退出游戏按钮
	setfillcolor(BLUE);
	fillrectangle(300, 500, 500, 550); // 按钮背景
	settextcolor(WHITE);
	setbkmode(TRANSPARENT);
	settextstyle(40, 0, _T("微软雅黑"));
	outtextxy(340, 500, _T("退出游戏")); // 按钮文字
